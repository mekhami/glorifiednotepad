---
title: "Solo FLAIL - The Flying Lootsman"
id: "solo-flail---the-flying-lootsman"
date: 2026-05-10
width: 60%
draft: false
sidenotes: true
---
==yellow:If you are party of my normal gaming group, don't read any further! Not until after our gaming getaway weekend, anyway!==
# Setup
...
[^1]:Sidenotes! I've added this feature so that I can add notes about my solo play as you're reading the fiction. You'll see some, but certainly not all, of the recorded dice rolls here. (The dice rolls would be longer than the fiction for most of the game!)
...
The purpose of this little solo adventure was to learn [FLAIL](https://www.backerkit.com/c/projects/games-omnivorous/flail-an-old-school-fantasy-brawler)!, a fantastic new hacky-slashy brawler of an OSR game. It's truly delightful, with a variety of tones, a simple but satisfying character creation process, and above all, an emphasis on getting into the game quickly and going. I found this to truly be the case here.[^2]

[^2]:The sidenotes notation will contain my recorded dice rolls using [Lonelog](https://zeruhur.itch.io/lonelog) notation! It's essential for keeping the game moving quickly and recording what's important for posterity.

I spent about the same amount of time in character creation as I did setting up character traits for [Triple-O](https://capacle.itch.io/triple-o), which is the emulator that I used here to determine what the party does. This allows me to run this game as the GM, so that I can play published modules with full knowledge, yet still be surprised and delighted at the outcomes and emergent narratives. This is largely driven by character traits and a simple dice system for determining party decisions. You'll see me refer to this in my sidenotes as Obvious, Option, and Odd - the Triple Os!

Finally, I'm playing through [The Flying Lootsman](https://www.patreon.com/posts/flail-flying-155857672) [^3]. I'm running this next weekend for my normal gaming group, so a big motivation for running this solo is to familiarize myself with the module, the new system, and character creation so that I can have a very smooth, fun experience with my gang.

[^3]:a one-shot module for FLAIL available to Patreon backers of Games Omnivorous
...
[^4]:? Where does the glider land? 1-2=Main Deck, 3-4=Quarter deck, 5-6=Poop Deck (lol)
d: d6=1
-> Main Deck
...
[^7]: @ Glazbad uses Lay on Hands on Gund.
d: d29<9=8 -> d:d6+1 -> Gund gains 6 HP
@ Meanwhile, everyone else takes a short rest to gain some HP.
d: d4=2 -> Everyone regains 2 hp.
...
[^9]:@ Gund tries to slam the door down. STR save.
d: d20<13=3 -> Success
...
[^11]:@ [Captain Skarx] fires the liquid flame-thrower at Gund
d: 7d6=5,4,3,1,5,3,5 -> Hit, 4 damage.

[^12]:Glazbad's backstory includes being burned alive as an apostate by a group of witches. Yikes!
...
[^13]:@ Gund gathers himself and launches himself at Skarx, trying to attack and disarm. On a failure, Skarx will get a free attack with his fire spouting gun. This is a warrior's **Extraordinary Feat**.
d: TH6, 6d6=1,4,6,2,5,5. STR save, d20<13=12
-> Gund's legendary blade slashes Skarx's arm, and Skarx drops the fiery weapon. 4 damage. [Skarx:5]
...
[^14]:@ [Skarx] grabs his great axe off the wall and chops down on Gund's head
d: Th6, 6d6=2,6,2,4,6,6
-> Fumble!
...
[^15]:? Does the Roc in the crow's nest become disturbed by the conflict?
Obvious: Yes, and it swoops down to attack
Option: Yes, but for now it just flaps its wings and screeches, posing a future threat
Odd: No, it remains fast asleep.
d: 2d6 Doubling Down=5,1
-> Obvious!
=> The Roc swoops down to attack the party as they emerge from the captain's chamber!
